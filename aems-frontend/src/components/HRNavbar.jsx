    ...
    <nav className="border-b border-gray-500 bg-black text-white px-6 py-4 flex justify-between items-center shadow-md">
      ...
      <div className="flex items-center space-x-9">
        ...
        <ul className="hidden md:flex space-x-8">
          <li>
            <a href="/hr/dashboard" className="hover:text-gray-400 hover">
              Dashboard
            </a>
          </li>
          <li>
            <a href="/hr/request-leave" className="hover:text-gray-400">
              Request Leave
            </a>
          </li>
          <li>
            <a href="hr/profile" className="hover:text-gray-400">
              Profile
            </a>
          </li>
        </ul>
