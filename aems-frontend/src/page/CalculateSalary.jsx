    ...
    return (
        ...
        <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
                ...
                <div>
                <label className="block text-sm text-zinc-400">Gross Salary</label>
                <input
                    type="number"
                    value={grossSalary}
            ...
            <div className="space-y-4">
                ...
                <div>
                <label className="block text-sm text-zinc-400">Total Deduction</label>
                <input
                    type="number"
        ...
        <div className="mt-6 flex justify-center items-center gap-4">
            ...
            <button className="ml-4 bg-red-600 px-6 py-3 rounded-xl text-sm font-semibold text-white hover:bg-red-400 shadow-md transition duration-200 ease-in-out"
